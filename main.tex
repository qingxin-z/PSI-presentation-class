...
\titlebackground{images/PSI_Arialview.jpg}
...
\begin{chapter}[images/uic_sunset.jpg]{psidarkgrey}{Slide Layouts}
...
\begin{chapter}[images/uic_seo.jpg]{psidarkgrey}{Personalization}
...
\begin{itemize}
    \item We are currently using \testcolor{psidarkgrey} color for our footer.
...
\item The colors are defined in the \texttt{uiccolor} package, in accordance with the \hrefcol{https://marketing.uic.edu/marketing-toolbox/university-style-guide/visual-elements/}{UIC Visual Elements guide}:
  \begin{itemize}
  \item UIC's primary colors are Navy Pier Blue (\testcolor{psidarkgrey}) and Fire Engine Red (\testcolor{psidarkgrey}).
...
\begin{chapter}[images/uic_halls.jpg]{psidarkgrey}{Title goes here}
\textit{Subtitle goes here}
\end{chapter}

\begin{chapter}[images/uic_skyline.jpg]{psidarkgrey}{Title goes here}
\textit{Subtitle goes here}
\end{chapter}
...
\begin{chapter}[images/dept_ece.png]{psidarkgrey}{Title goes here}
\textit{Subtitle goes here}
\end{chapter}

\begin{chapter}[images/dept_cs.png]{psidarkgrey}{Title goes here}
\textit{Subtitle goes here}
\end{chapter}
